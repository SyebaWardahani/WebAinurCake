                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button data-toggle="modal" data-target="#ModalKonfirmasi"
                                                        ...
                                                        onclick="konfirmasi_orders(<?php echo $res['orders_id']; ?>)">Konfirmasi</button>
                                                    <button data-toggle="modal" data-target="#cancel_order"
                                                        onclick="cancel_orders(<?php echo $res['orders_id']; ?>)"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button data-toggle="modal" data-target="#exampleModal1"
                                                        ...
                                                        onclick="editOrdersDetail( $order )">Edit</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
...
<div class="modal fade" id="exampleModal1" data-backdrop="static" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="editOrderDetailForm" method="post">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="inputQuantity" type="number" min="1" max="50" name="quantity" required=""
                            placeholder="Enter quantity" autocomplete="off" class="form-control">
                    </div>
                    <input type="hidden" name="hidden_orders_detail" id="hiddenOrdersDetail">
                </div>
                <div class="modal-footer">
                    <button type="reset" class="btn btn-space btn-secondary">Clear</button>
                ...
                <form action="konfirmasi_orders.php" id="form" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="inputUsersId">Users id</label>
                            <input id="inputUsersId" type="number" min="1" name="users_id" required=""
                                placeholder="Enter users id" autocomplete="off" class="form-control" disabled>
                        </div>
                        <div class="form-group">
                            <label for="inputDeliveryDate">Orders date</label>
                            <input id="inputDeliveryDate" type="date" name="orders_date" required=""
                                placeholder="Enter delivery date" autocomplete="off" class="form-control" disabled>
                        </div>
                        <div class="form-group">
                            <label for="inputDeliveryDate">Delivery date</label>
                            <input id="inputDeliveryDate" type="date" name="delivery_date" required=""
                        ...
                        <div class="form-group">
                            <label for="inputTotalAmount">Total amount</label>
                            <input id="inputTotalAmount" type="number" min="1" name="total_amount" required=""
                                placeholder="Enter total amount" autocomplete="off" class="form-control" disabled>
                        </div>
    ...
    function editOrdersDetail(orderDetail) {
        $('#inputOrdersId').val(orderDetail.orders_id);
        $('#inputProductName').val(orderDetail.product_name);
        $('#inputQuantity').val(orderDetail.quantity);
        $('#hiddenOrdersDetail').val(orderDetail.orders_detail_id);
        ...
        $('#editOrderDetailForm').on('submit', function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    location.reload(); // Reload the page or update data dynamically
                },
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire({
                    ...
                    window.location.href = "delete_orders_detail.php?orders_detail_id=" +
                        orders_detail_id;
                });
            }
        });
